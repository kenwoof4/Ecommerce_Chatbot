        ...
        <Router>
          <div style={{height: '100vh'}}>
            ...
            <Routes>
              ...
              <Route path="/signUp" element={<SignUp signUp={(username, password, firstName, lastName) => this.signUp(username, password, firstName, lastName)}/>} />
              <Route path="/signIn" element={<SignIn signIn={(username, password) => this.signIn(username, password)}/>} />
              {this.getUserRoutes()}
